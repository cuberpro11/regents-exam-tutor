...
export default async function GeometryPage() {
  ...
  if (session) {
    ...
    if (purchases.some((p) => p.course_name === COURSE_NAMES.geometry)) {
      redirect("/dashboard");
    }
  }
    ...
    <main>
      <section className="course-details-section">
        <div className="course-details-container">
          <div className="course-details-image-area">
          ...
          <aside className="course-details-aside">
            <CoursePurchaseCard courseName={COURSE_NAMES.geometry} />
          </aside>
          <div className="course-details-content-area">
